				...
				<form action="" method="post">
					<ul>
						...
						<li class="checkcode">
							...
							<img src="<?php echo U('getCaptcha','type=login');?>" alt="" />
...
<script type="text/javascript">
	...
	{
		childWindow = window.open("<?php echo U('oauth');?>","TencentLogin","width=450,height=320,menubar=0,scrollbars=1, resizable=1,status=1,titlebar=0,toolbar=0,location=1");
	}
