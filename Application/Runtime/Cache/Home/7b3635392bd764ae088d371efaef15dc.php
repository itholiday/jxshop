...
<body>
	...
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<?php if(empty($_SESSION['user_id'])): ?><li>您好，欢迎来到京西！
						[<a href="<?php echo U('user/login');?>">登录</a>] [<a href="<?php echo U('user/regist');?>">免费注册</a>]
						<?php else: ?>您好<?php echo ($_SESSION['user']['username']); ?>，欢迎来到京西！<?php endif; ?>
					</li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="/Public/Home/">首页</a> > <a href="/Public/Home/">电脑、办公</a> > <a href="/Public/Home/">笔记本</a> > ThinkPad X230(23063T4）12.5英寸笔记本</h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="goods_left fl">
			...
			<div class="related_cat leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li><a href="/Public/Home/">笔记本</a></li>
						<li><a href="/Public/Home/">超极本</a></li>
						<li><a href="/Public/Home/">平板电脑</a></li>
					</ul>
				</div>
			</div>
			<!-- 相关分类 end -->
			...
			<div class="related_cat	leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li><a href="/Public/Home/">D-Link</a></li>
						<li><a href="/Public/Home/">戴尔</a></li>
						<li><a href="/Public/Home/">惠普</a></li>
						<li><a href="/Public/Home/">苹果</a></li>
						<li><a href="/Public/Home/">华硕</a></li>
						<li><a href="/Public/Home/">宏基</a></li>
						<li><a href="/Public/Home/">神舟</a></li>
					</ul>
				</div>
			</div>
			<!-- 相关品牌 end -->
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href="/Public/Home/"><img src="/Public/Home/images/relate_view1.jpg" alt="" /></a></dt>
								<dd><a href="/Public/Home/">ThinkPad E431(62771A7) 14英寸笔记本电脑 (i5-3230 4G 1TB 2G独显 蓝牙 win8)</a></dd>
						...
						<li>
							<dl>
								<dt><a href="/Public/Home/"><img src="/Public/Home/images/relate_view2.jpg" alt="" /></a></dt>
								<dd><a href="/Public/Home/">ThinkPad X230i(2306-3V9） 12.5英寸笔记本电脑 （i3-3120M 4GB 500GB 7200转 蓝牙 摄像头 Win8）</a></dd>
								<dd><strong>￥5199.00</strong></dd>
							</dl>
						</li>
						...
						<li>
							<dl>
								<dt><a href="/Public/Home/"><img src="/Public/Home/images/relate_view3.jpg" alt="" /></a></dt>
								<dd><a href="/Public/Home/">T联想（Lenovo） Yoga13 II-Pro 13.3英寸超极本 （i5-4200U 4G 128G固态硬盘 摄像头 蓝牙 Win8）晧月银</a></dd>
						...
						<li>
							<dl>
								<dt><a href="/Public/Home/"><img src="/Public/Home/images/relate_view4.jpg" alt="" /></a></dt>
								<dd><a href="/Public/Home/">联想（Lenovo） Y510p 15.6英寸笔记本电脑（i5-4200M 4G 1T 2G独显 摄像头 DVD刻录 Win8）黑色</a></dd>
						...
						<li class="last">
							<dl>
								<dt><a href="/Public/Home/"><img src="/Public/Home/images/relate_view5.jpg" alt="" /></a></dt>
								<dd><a href="/Public/Home/">ThinkPad E530c(33662D0) 15.6英寸笔记本电脑 （i5-3210M 4G 500G NV610M 1G独显 摄像头 Win8）</a></dd>
			...
			<div class="viewd leftbar mt10">
				<h2><a href="/Public/Home/">清空</a><strong>最近浏览过的商品</strong></h2>
				<div class="leftbar_wrap">
					<dl>
						<dt><a href="/Public/Home/"><img src="/Public/Home/images/hpG4.jpg" alt="" /></a></dt>
						<dd><a href="/Public/Home/">惠普G4-1332TX 14英寸笔记...</a></dd>
					</dl>

					<dl class="last">
						<dt><a href="/Public/Home/"><img src="/Public/Home/images/crazy4.jpg" alt="" /></a></dt>
						<dd><a href="/Public/Home/">直降200元！TCL正1.5匹空调</a></dd>
					</dl>
				</div>
			</div>
			<!-- 最近浏览 end -->
			...
			<div class="summary">
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="shop_price"><span>本店价：</span> <strong>￥<?php echo ($goods["shop_price"]); ?></strong> <a href="/Public/Home/">(降价通知)</a></li>
						<li><span>上架时间：</span><?php echo (date('Y-m-d',$goods["addtime"])); ?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="/Public/Home/">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
			...
			<div class="detail" id="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
							<?php if(is_array($uniqid)): $i = 0; $__LIST__ = $uniqid;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><span><?php echo ($vo["attr_name"]); ?>：</span><?php echo ($vo["attr_values"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
							</ul>
						</div>
					...
					<div class="comment detail_div mt10">
						<div class="comment_summary">
							...
							<div class="buyer fl">
								<dl>
									<dt>买家印象：</dt>
									<?php if(is_array($buyer)): $i = 0; $__LIST__ = $buyer;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dd><span><?php echo ($vo["name"]); ?></span><em>(<?php echo ($vo["count"]); ?>)</em></dd><?php endforeach; endif; else: echo "" ;endif; ?>
								</dl>
							</div>
						</div>
						<?php if(is_array($comment["list"])): $i = 0; $__LIST__ = $comment["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href="/Public/Home/"><img src="/Public/Home/images/user1.gif" alt="" /></a></dt>
									<dd><a href="/Public/Home/"><?php echo ($vo["username"]); ?></a></dd>
								</dl>
							</div>
							<div class="item">
								<div class="title">
								...
								<div class="btns">
									<a href="/Public/Home/" class="reply">回复(0)</a>
									<a href="javascript:;" data-id="<?php echo ($vo["id"]); ?>"  class="useful">有用(<span><?php echo ($vo["good_number"]); ?></span>)</a>
								</div>
							</div>
						...
						<!--  评论表单 start-->
						<?php if(!empty($_SESSION['user_id'])): ?><div class="comment_form mt20">
							<form action="<?php echo U('comment');?>" method="post">
								<ul>
									...
									<li>
										...
										<?php if(is_array($buyer)): $i = 0; $__LIST__ = $buyer;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="checkbox" name="old[]" value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); endforeach; endif; else: echo "" ;endif; ?>
									</li>
									<li>
										<label for="">买家印象：</label>
										<input type="text" name="name">(对于多个印象使用英文逗号隔开)
									</li>
									<li>
